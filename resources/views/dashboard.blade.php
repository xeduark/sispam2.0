...
@if (request('error') === 'acceso_denegado')
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <i class="fa-solid fa-ban me-1"></i> No tiene permisos para acceder a ese módulo.
...
<div class="row mb-4">
    ...
    <div class="col-md-4 text-md-end align-self-center">
        <span class="badge bg-light text-dark p-2 border shadow-sm">
            <i class="fa-regular fa-clock me-1 text-primary"></i> {{ now()->format('d/m/Y h:i A') }}
        </span>
    </div>
</div>
        ...
        <div class="card card-glass border-start border-4 border-primary p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="fs-2 fw-bold text-primary">{{ $totalTranscripcion }}</div>
                </div>
        ...
        <div class="card card-glass border-start border-4 border-warning p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="fs-2 fw-bold text-warning">{{ $totalAlistamiento }}</div>
                </div>
        ...
        <div class="card card-glass border-start border-4 border-info p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="fs-2 fw-bold text-info">{{ $totalEntrega }}</div>
                </div>
        ...
        <div class="card card-glass border-start border-4 border-success p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="fs-5 fw-bold text-success">{{ auth()->user()->rol?->nombre ?: 'Usuario' }}</div>
                </div>
...
<div class="row g-4">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card card-glass h-100 p-3">
            <div class="card-body">
                ...
                <a href="{{ route('transcripcion.index') }}" class="btn btn-sm fw-bold" style="color:#4f46e5; border-color:#4f46e5;" ><i class="fa-solid fa-arrow-right me-1"></i> Ir a Transcripción</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card card-glass h-100 p-3">
            <div class="card-body">
                <h5 class="fw-bold text-warning"><i class="fa-solid fa-boxes-packing me-2"></i> Alistamiento y Turneros</h5>
                ...
                <a href="{{ route('alistamiento.index') }}" class="btn btn-outline-warning text-dark btn-sm fw-bold"><i class="fa-solid fa-arrow-right me-1"></i> Ir a Alistamiento</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card card-glass h-100 p-3">
            <div class="card-body">
                <h5 class="fw-bold text-info"><i class="fa-solid fa-signature me-2"></i> Entrega y Firma Digital</h5>
                ...
                <a href="{{ route('entrega.index') }}" class="btn btn-outline-info text-dark btn-sm fw-bold"><i class="fa-solid fa-arrow-right me-1"></i> Ir a Entrega</a>
            </div>
        </div>
    </div>
        ...
        <div class="card card-glass h-100 p-3">
            <div class="card-body">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('turnero.uno') }}" target="_blank" class="btn btn-sm btn-dark"><i class="fa-solid fa-desktop me-1"></i> TV 1</a>
                    <a href="{{ route('turnero.dos') }}" target="_blank" class="btn btn-sm btn-primary"><i class="fa-solid fa-bullhorn me-1"></i> TV 2</a>
                </div>
            </div>
        </div>
    </div>
